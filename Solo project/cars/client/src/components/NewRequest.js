                ...
                <form className="container m-3" onSubmit={SubmiHandler}>
                    <div className="row text-center mt-3">
                        <div className="col-6 ">
                            ...
                            <div className="row mb-3">
                                <label className="col-sm-5 col-form-label">Manufacturer company</label>
                                <div className="col-sm-5">
                                    <input
                                        type="text" className="form-control"
                                        name="manufacturer"
                                        ...
                                        value={(manufacturer)}
                                    />
                                    {ObjErrors.manufacturer ? <p style={{ color: "red" }} >{ObjErrors.manufacturer}</p> : null}

                                </div>
                            </div>

                            <div className="row mb-3">
                                <label className="col-sm-5 col-form-label">Car model</label>
                                <div className="col-sm-5">
                                    <input
                                        type="text" className="form-control"
                                        name="model"
                                        ...
                                        value={(model)}
                                    />
                                    {ObjErrors.model ? <p style={{ color: "red" }} >{ObjErrors.model}</p> : null}

                                </div>
                            </div>

                            <div className="row mb-3">
                                <label className="col-sm-5 col-form-label">Car Mileage</label>
                                <div className="col-sm-5">
                                    <input
                                        type="text" className="form-control"
                                        name="position"
